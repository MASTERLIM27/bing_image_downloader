...
downloader.download(query_string, limit=100,  output_dir='dataset', page_limit=100, adult_filter_off=True, force_replace=False, timeout=60,resize=(224,224) ,verbose=True)
```
